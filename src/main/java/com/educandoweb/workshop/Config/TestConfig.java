...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		//Salvando as associações no paradigma relacional que é o do banco de dados
		productRepository.saveAll(Arrays.asList(p1,p2,p3,p4,p5));
		...
		o1.setPayment(pay1); //Associando o meu pedido 'o1' com o pagamento 'pay1'
		
		orderRepository.save(o1); //Para salvar um objeto dependente OneToOne, não chama o 'save' do próprio objeto
								//Por a associação acima em memória, então deve ser salvo o pedido novamente.
	}
}
